...
<title>Upload File - File Manager</title>
<style type="text/css">
.tdBackgroundEven {
							...
							<tr>
								<td>
									<form action="/fileuploader/uploadServlet" method="post" enctype="multipart/form-data">
										<div><input type="file" name="file" title="Upload File" style="font-size: 14px;height: 30px;"/></div>
										<div style="margin-top: 25px;">
											<input type="submit" value="Submit" class="btnCss"/>
											<!-- <div style="display:inline; width:10px; min-width: 10px;"></div> -->
											<a href="/fileuploader/uploadServlet" class="btnCss" style="padding-bottom:12px;margin-left: 8px;">Cancel</a>
										</div>
									</form>					
								</td>
							</tr>
